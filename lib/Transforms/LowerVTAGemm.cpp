...
struct LowerVTAGemmPass
  ...
  StringRef getDescription() const final {
    return "Lower single-block vta.gemm to VTA ISA ops";
  }
  ...
  void runOnOperation() override {
    ...
    for (vta::GemmOp g : targets) {
      ...
      b.create<vta::UopTableOp>(loc, b.getI64ArrayAttr({0, 0}),
                                b.getI64ArrayAttr({0, 0}),
                                b.getI64ArrayAttr({0, 0}));

      // 2. load UOP sram=0 dram=5120 y=1 x=1 stride=1
      b.create<vta::LoadOp>(loc, vta::BufferId::UOP, /*pop_prev=*/false,
      ...
      b.create<vta::GemmInsnOp>(loc, /*pop_prev=*/false, /*pop_next=*/false,
      ...
      b.create<vta::LoadOp>(loc, vta::BufferId::INP, /*pop_prev=*/false,
      ...
      b.create<vta::LoadOp>(loc, vta::BufferId::WGT, /*pop_prev=*/false,
                            /*pop_next=*/false, /*push_prev=*/false,
      ...
      b.create<vta::LoadOp>(loc, vta::BufferId::ACC, /*pop_prev=*/true,
                            /*pop_next=*/false, /*push_prev=*/false,
                            /*push_next=*/false, /*sram_base=*/0,
      ...
      b.create<vta::StoreOp>(loc, vta::BufferId::OUT, /*pop_prev=*/true,
      ...
      b.create<vta::LoadOp>(loc, vta::BufferId::UOP, /*pop_prev=*/true,
                            /*pop_next=*/true, /*push_prev=*/false,
                            /*push_next=*/false, /*sram_base=*/0,
                            /*dram_base=*/0, /*y_size=*/0, /*x_size=*/0,
                            /*x_stride=*/0);
