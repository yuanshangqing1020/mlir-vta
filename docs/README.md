...
| [plans/phase4-onnx-frontend.md](plans/phase4-onnx-frontend.md) | 阶段四实施计划（增量 A ✅） |
| [plans/phase4-increment-FG.md](plans/phase4-increment-FG.md) | 阶段四增量 F→G 实施计划（CPU 算子 + LeNet-5；D 暂缓） |
